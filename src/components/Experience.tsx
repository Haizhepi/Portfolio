...
const useStyles = makeStyles((theme) => ({
  ...
  timeLineItem: {
    ...
    "&:before": {
      ...
      top: "calc(50% - 5px)",
      borderStyle: "solid",
      borderColor: "yellow tomato transparent transparent",
    ...
    [theme.breakpoints.up("md")]: {
      ...
      "&:nth-of-type(2n):before": {
        right: "auto",
        left: "-0.625rem",
        borderColor: "transparent transparent tomato yellow",
      },
    },
  },
  timeLineYear: {
        ...
        <Box component="div" className={classes.timeLine}>
          ...
          <Box component="div" className={classes.timeLineItem}>
            ...
            >
              ...
              <a href="yourmorals.org" target="_blank" className={classes.link}>
                Yourmorals.org
              </a>
            </Typography>
            <Typography
              ...
              className={classes.subtitle1}
            >
              Migrate the old Yourmorals (PHP & MySQL) website with MERN stack
              to AWS.
            </Typography>
            <Typography
              variant="subtitle1"
              ...
              className={classes.subtitle1}
            >
              Designed System to work with 800k users and 200 daily active users
            </Typography>
          </Box>
          <Typography
            variant="h2"
